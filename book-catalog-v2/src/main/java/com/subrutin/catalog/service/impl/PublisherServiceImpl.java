...
public class PublisherServiceImpl implements PublisherService {
	...
	public void updatePublisher(String id, PublisherUpdateRequestDTO dto) {
		Publisher publisher = repository.findBySecureId(id)
		...
		publisher.setCompanyName(dto.getCompanyName() == null ? publisher.getCompanyName() : dto.getCompanyName());
		publisher.setAddress(dto.getAddress());
	...
	public ResultPageResponseDTO<PublisherListResponseDTO> findPublisherList(Integer pages, Integer limit,
		...
		Page<Publisher> pageResult = repository.findByNameLikeIgnoreCase(publisherName, pageable);
	...
	public Publisher findPublisher(String publisherId) {
		Publisher publisher = repository.findBySecureId(publisherId)
				.orElseThrow(() -> new BadRequestException("invalid.publisher_id"));
		return publisher;
	}
